...
CREATE DATABASE IF NOT EXISTS `cmsToMVC-biv` /*!40100 DEFAULT CHARACTER SET latin1 */;
USE `cmsToMVC-biv`;
...
-- Dumping data for table cmsToMVC-biv.articles: ~7 rows (approximately)
...
-- Dumping structure for table cmsToMVC-biv.article_users
...
-- Dumping data for table cmsToMVC-biv.article_users: ~10 rows (approximately)
...
-- Dumping data for table cmsToMVC-biv.users: ~5 rows (approximately)
